#Javier Azahel Gutierrez Munguia - 219209037
...
pygame.draw.circle(crosshair, pygame.Color("orchid"), (5, 5), 10, 0)#darkgoldenrod
...
while True:
    ...
    if Keys[pygame.K_v]: screen.blit(crosshair, (221, 122))#botton a    del control
    if Keys[pygame.K_z]: screen.blit(crosshair, (197, 142))#botton b    del control
